...
public class CalculatorTest {
    public static void main(String[] args) {
        System.out.println(Calculator.calculateDiscount(1000,15));

        testCalculateDiscountValidArguments();
        testCalculateDiscountNegativePurchaseAmount();
        testCalculateDiscountNegativeDiscountPercentage();
        testCalculateDiscountInvalidDiscountPercentage();
...
//        System.out.println(Calculator.squareRootExtraction(169));
    ...
    private static void testCalculateDiscountValidArguments() {
        assertThat(Calculator.calculateDiscount(100, 10)).isEqualTo(90);
        assertThat(Calculator.calculateDiscount(200, 20)).isEqualTo(160);
    }

    private static void testCalculateDiscountNegativePurchaseAmount() {
        assertThatThrownBy(() ->
                Calculator.calculateDiscount(-50, 10)
        ).isInstanceOf(ArithmeticException.class);
    }

    private static void testCalculateDiscountNegativeDiscountPercentage() {
        assertThatThrownBy(() ->
                Calculator.calculateDiscount(100, -10)
        ).isInstanceOf(ArithmeticException.class);
    }

    private static void testCalculateDiscountInvalidDiscountPercentage() {
        assertThatThrownBy(() ->
